  ...
  return <div className="min-h-screen bg-[#F7F3ED] px-5 py-10 flex items-center justify-center">
    <div className="w-full max-w-[510px] overflow-hidden rounded-[30px] border border-[#D9C7B9] bg-[#FBF8F3] shadow-[0_28px_80px_rgba(52,38,31,.12)]">
      ...
      <form onSubmit={submit} className="px-7 py-7 md:px-10 md:py-9 space-y-4">
        ...
        <label className="block"><span className="mb-2 block text-[9px] uppercase tracking-[.16em] text-taupe">Contraseña</span><input type="password" required value={password} onChange={e=>setPassword(e.target.value)} className="w-full rounded-[14px] border border-[#DCCCBF] bg-white/80 px-4 py-3.5 text-[14px] outline-none focus:border-mocha"/></label>
