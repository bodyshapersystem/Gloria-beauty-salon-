...
export default function ProgressPage(){
  ...
  return <div className="pb-5">
    ...
    {isSalon&&<section className="mt-5 rounded-[28px] border border-[#DACBBF] bg-[#FCF9F5] p-5 md:p-6 shadow-[0_12px_34px_rgba(52,38,31,.05)]">
      <div className="flex items-center justify-between"><div><p className="text-[8px] uppercase tracking-[.2em] text-mocha">Desempeño individual</p><h2 className="mt-1 font-serif text-[30px]">El brillo de cada profesional</h2></div><UsersRound size={18} className="text-[#7B3C48]"/></div>
